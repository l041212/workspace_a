...
(function ($) {
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showRefresh) {
            html.push(sprintf('<button class="btn btn-white btn-info btn-round' +
                    sprintf(' btn-%s', this.options.buttonsClass) +
                    sprintf(' btn-%s', this.options.iconSize) +
        ...
        if (this.options.showColumns) {
            html.push(sprintf('<div class="keep-open btn-group" title="%s">',
                ...
                '<button type="button" aria-label="columns" class="btn btn-white btn-bold  btn-round' +
                sprintf(' btn-%s', this.options.buttonsClass) +
                sprintf(' btn-%s', this.options.iconSize) +
    ...
    BootstrapTable.prototype.initServer = function (silent, query, url) {
        ...
        request = $.extend({}, calculateObjectValue(null, this.options.ajaxOptions), {
            ...
            data: this.options.contentType === 'application/x-www-form-urlencoded' && this.options.method === 'post' ?
